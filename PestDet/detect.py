...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/newVOC_2023.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--visualize', default=ROOT / 'vis/', help='visualize features')
